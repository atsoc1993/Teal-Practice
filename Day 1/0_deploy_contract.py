from algokit_utils import AppManager, AlgorandClient, AppCreateParams, SigningAccount
...
approval_teal = open("Day 1/approval.teal").read()
clear_teal = open("Day 1/clear.teal").read()
